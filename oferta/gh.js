document.addEventListener('DOMContentLoaded', () => {
  //console.log("Shader carregado:", vertexShader, fragmentShader);
  //console.log("Uniforms:", uniforms);
  //console.log("Partículas:", geometry.attributes);    
  const pic_url =
...
class WebGL {
  ...
  init() {
    ...
    const _contentCanvas = document.getElementById("content-canvas");
